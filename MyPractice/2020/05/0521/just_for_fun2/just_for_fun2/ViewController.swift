...
//        dice_image_views = [self.imgDice1, self.imgDice2, self.imgDice3, self.imgDice4]
...
//        var dices:[Int] = [1, 2, 3, 4]
//        for index in 0...3 {
//            dices[index] = Int.random(in: 1...6)
//        }
////        print(dices)
//        for view in dice_image_views {
//            view.image = NSImage(named: "dice3")
//        }
        // Home Work
