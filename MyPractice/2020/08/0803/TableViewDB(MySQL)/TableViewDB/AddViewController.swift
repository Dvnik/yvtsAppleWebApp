...
//        print("按下Return鍵")
    ...
    @IBAction func btnInsert(_ sender: UIButton)
    {
        ...
        //Step2.回寫上一頁的陣列資料
        let newRow =
            Student(no: txtNo.text!.uppercased(), name: txtName.text!, gender: pkvGender.selectedRow(inComponent: 0), picture: imgPicture.image!.jpegData(compressionQuality: 0.8), phone: txtPhone.text!, address: txtAddress.text!, email: txtEmail.text!, myclass: txtClass.text!)
